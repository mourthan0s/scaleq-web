...
| `public/projects/pawera/logo.png` | PawEra | Provided directly by the product owner (ORBIQ) — high-resolution version (2608×2968) supplied by the user July 2026, replacing an earlier lower-res copy | Product logo supplied by ORBIQ for this presentation. © ORBIQ. | PawEra detail hero, Featured Projects spotlight (listing + homepage) |
| `public/projects/nbg-mobile-banking/logo.png` | NBG Mobile Banking (Featured) | Official App Store app icon, retrieved via Apple's public iTunes lookup API (id 342152889), 512×512 (July 2026) | Official app icon published by National Bank of Greece S.A. on its App Store listing; used unaltered. © National Bank of Greece S.A. | Featured Projects spotlight (listing + homepage) |
| `public/projects/nbg-next/logo.png` | NBG Next (Featured) | Official App Store app icon for "Next by NBG", retrieved via Apple's public iTunes lookup API (id 1058862350), 512×512 (July 2026) | Official app icon published by National Bank of Greece S.A. on its App Store listing; used unaltered. © National Bank of Greece S.A. | Featured Projects spotlight (listing + homepage) |
| `public/projects/orlik-gallery/logo.png` | Orlik Gallery (Featured) | Official website site-icon asset: https://orlikgallery.com/wp-content/uploads/2022/04/cropped-LOGO-WHITE-LETTERS-e1651076831610-348x464-1-454x454.png (retrieved from https://orlikgallery.com/, July 2026) | Official brand logo (teal "OG" monogram), used unaltered (454×454, transparent PNG). © Orlik Gallery. | Featured Projects spotlight (listing + homepage) |
| `public/projects/media-strom/logo.png` | Media Strom (Featured) | Official website logo: https://www.mediastrom.com/image/catalog/medialogo.png (retrieved from https://www.mediastrom.com/, July 2026) | Official brand logo, used unaltered (541×190, transparent PNG). © Media Strom. | Featured Projects spotlight (listing + homepage) |
...
| `public/projects/logos/discoverathenstours.webp` | Discover Athens Tours (Professional Contributions) | Official website site-icon asset: https://discoverathenstours.com/wp-content/uploads/2025/05/cropped-DISPLAY_ATHENS_TOURS_LOGOwebp-e1748372733561.webp (retrieved from https://discoverathenstours.com/, July 2026). Replaces an earlier cream-on-white header crop that was nearly invisible on a light card background — this is the site's own solid-navy icon variant of the same mark. | Official brand logo, used unaltered at native resolution (512×512, navy background webp). © Discover Athens Tours. | Trusted Experience logo wall, Professional Contributions card |
